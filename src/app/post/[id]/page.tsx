        ...
        <ContainerS>
            ...
            <div className="w-screen h-screen flex items-center justify-center flex-col bg-background">
                ...
                <div className="max-w-7xl h-3/6 text-xl has-dropcap overflow-auto scrollbar">
                    ...
                    Minus voluptas nobis distinctio sed, maxime labore amet mollitia perspiciatis provident blanditiis fugit veritatis sequi voluptatibus, dignissimos impedit quae quia voluptate ipsa non, omnis accusamus eius aut! Quod, voluptatum aperiam.
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eos corrupti natus sit culpa, illum molestiae iure eum! Veniam temporibus voluptatibus dolor sunt quae incidunt itaque corrupti, exercitationem deserunt error doloremque!
                    </p>
                </div>
            </div>
